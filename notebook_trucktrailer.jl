...
begin
    ...
    f = [
	    ...
	    v1 * cos(theta1) + zero(u[1]),
	    v1 * sin(theta1) + zero(u[2]),
	    dtheta0 + zero(u[3]),
	    (v0 / L1) * sin(beta01) - (M0 / L1) * cos(beta01) * dtheta0 + zero(u[4]),
	    zero(u[5]),  # v0 remains constant
	    zero(u[6])  # dtheta0 remains constant
	]

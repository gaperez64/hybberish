...
plot!(pltND1, eseries[1], label="Numerically Integrated")
plot!(pltND2, eseries[1], label="Numerically Integrated")
pltND = plot(pltND1, pltND2, legend=:outertop, plot_title="Order k=$ord")
